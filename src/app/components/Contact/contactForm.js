        ...
        <div>
            <div className="border bg-neutral-300 shadow w-11/12 -z-10 absolute top-0 right-0 bottom-0 left-0 mx-auto mt-[6.75rem] h-96">
                <div className="animate-pulse relative w-full h-full">
                    <div className="w-72 h-20 rounded-2xl absolute bg-neutral-400 top-4 left-[0.7rem]"></div>
            ...
            <form>
                <div className="flex flex-wrap flex-row row w-11/12 mx-auto gap-7 justify-center">
                    <input className="w-[48%] mt-8 px-3 py-3 bg-neutral-900 ring-neutral-500 ring-1 rounded-md
            ...
            shadow-lg shadow-neutral-950/50 focus:outline-none focus:border-neutral-500 focus:ring-2 focus:ring-neutral-500 placeholder-neutral-400" placeholder="Email Address"></input>
                    <textarea rows="6" className="w-full px-3 py-3 bg-neutral-900 ring-neutral-500 ring-1 rounded-md
            shadow-lg shadow-neutral-950/50 focus:outline-none focus:border-neutral-500 focus:ring-2 focus:ring-neutral-500 placeholder-neutral-400" placeholder="Message"></textarea>
                ...
                <div className="mt-4 flex w-11/12 flex-row-reverse mx-auto">
                    <button className="border border-neutral-700 bg-neutral-900 shadow-lg shadow-neutral-950/50 rounded-md py-4 px-5 mb-7">
                        <span>
